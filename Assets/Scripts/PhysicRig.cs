...
public class PhysicRig : MonoBehaviour
{
    ...
    public float bodyHeightMax = 1f;

    void FixedUpdate()
    {
        bodyCollider.height = Mathf.Clamp(playerHead.position.y, bodyHeightMin, bodyHeightMax);
        bodyCollider.center = new Vector3(playerHead.position.x, bodyCollider.height/2, playerHead.position.z);
